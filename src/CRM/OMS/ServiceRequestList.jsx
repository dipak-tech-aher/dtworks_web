...
const ServiceRequestList = (props) => {
    const { serviceRequestList } = props?.data
    ...
    return (
        <>
            {
                (serviceRequestList?.rows && serviceRequestList?.rows?.length > 0) ?
                    <DynamicTable
                        isScroll={isScroll}
                        row={serviceRequestList?.rows}
                    ...
                    />
                    :
                    <span className="msg-txt">No Service Request History Available</span>
            }
                    ...
                    {!!!isShowWorkflow && <>
                        ...
                        <div className="cust360 col-lg-12 col-md-12 col-xs-12">
                            ...
                            <div className="row col-12 pt-1">
                                ...
                                <div className="col-3">
                                    <div className="form-group">
                                        <label htmlFor="inputName" className="col-form-label">Plan</label>
                                        <p>{interactionDetails?.plan ?? '-'}</p>
                                    </div>
                                </div>
                                <div className="col-9">
                                    <div className="form-group">
