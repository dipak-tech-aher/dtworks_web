...
const DeptWiseStakeholdersTask = (props) => {
    ...
    useEffect(() => {
        ...
        post(properties.LEAD_API + "/dept-wise-open-task-stakeholders", { searchParams: reqBody }).then((response) => {
...
export default DeptWiseStakeholdersTask;