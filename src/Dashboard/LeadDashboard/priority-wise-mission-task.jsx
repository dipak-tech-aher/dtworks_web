...
const PriorityWiseMissionTask = (props) => {
    ...
    useEffect(() => {
        ...
        post(properties.LEAD_API + "/missions-by-priority", { searchParams: reqBody }).then((response) => {
...
export default PriorityWiseMissionTask;