    ...
    return (
        <>
            <div className="skel-dashboard-title-base">
                <span className="txt-black cursor-pointer skel-targt-info mr-2" onClick={() => clickToScroll?.()}>Pooled {fromComp === 'ORDER' ? 'Orders' : fromComp === 'INTERACTION' ? 'Interactions' : ''} ({fromComp === 'ORDER' ? allPooledCounts?.order ?? 0 : fromComp === 'INTERACTION' ? allPooledCounts?.interaction ?? 0 : 0} ) <span class="blink"><i class="fa fa-angle-double-down" aria-hidden="true"></i></span></span> | <span className="skel-header-title mb-0 pl-2">Assigned To {meOrMyTeam} ({totalCount})</span>
            </div>
