...
import TopFivePerformanceChart from "./TopFivePerformanceChart";

const TopFivePerformance = (props) => {
    ...
    useEffect(() => {
        ...
        post(properties.LEAD_API + `/tasks/top-five/performance`, { searchParams: searchParamss }).then((response) => {
    ...
    }, [currentPage, listFilter, perPage])
    ...
    return (
        <div className="cmmn-skeleton mh-575">
            <div className="skel-dashboard-title-base">
                <span className="skel-header-title">Top 5 performance by Task</span>
