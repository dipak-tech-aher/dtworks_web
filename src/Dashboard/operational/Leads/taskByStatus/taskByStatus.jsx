...
import TaskByStatusChart from "./TaskByStatusChart";
...
const TaskByStatus = (props) => {
    ...
    useEffect(() => {
        ...
        post(properties.LEAD_API + `/task-by-status`, { searchParams: searchParamss }).then((response) => {
    ...
    return (
        <div className="cmmn-skeleton mh-575">
            <div className="skel-dashboard-title-base">
                <span className="skel-header-title">Tasks By Status</span>
            ...
            <Modal show={show} backdrop="static" keyboard={false} onHide={handleClose} dialogClassName="cust-lg-modal" >
                <Modal.Header>
                    <b>Task Status Details {totalCount}</b>
