...
const ByProject = (props) => {
    ...
    const getProjectWiseHelpdesk = (searchParams) => {
        ...
        axios.post(API_ENDPOINT + properties.HELPDESK_API + '/project-wise', { ...searchParams, mode: 'LIVE' }, {
            headers: {
            ...
            respData?.forEach(item => {
                ...
                const status = !item?.projectDesc?.description ? 'In Queue' : item?.projectDesc?.description;
