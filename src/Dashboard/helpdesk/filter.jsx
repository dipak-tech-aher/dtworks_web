...
const Filter = (props) => {
    ...
    const [helpdeskChannels, setHelpdeskChannels] = useState([]);
    ...
    useEffect(() => {
        ...
        get(properties.MASTER_API + '/lookup?searchParam=code_type&valueParam=PROJECT,HELPDESK_STATUS,PRIORITY,SEVERITY,HELPDESK_SOURCE,HELPDESK_TYPE').then((response) => {
            const { data } = response;
            ...
            setHelpdeskChannels(data?.HELPDESK_SOURCE?.map((ele) => {
                return {
                    label: ele?.description,
                    value: ele?.code
                }
            ...
            setHelpdeskTypes(data?.HELPDESK_TYPE?.map((ele) => {
                return {
                    label: ele?.description,
                    value: ele?.code
                }
    ...
    const onSubmit = (data) => {
        ...
        setSubmitError(null);
        const noFilterSelected = !data?.dateRange?.length && !data.project && !data.status && !data.severity && !data?.userId && !data.ageing && !data?.helpdeskType && !data?.channel && !data?.priority;
        if (noFilterSelected) {
        ...
        <div className="skel-filter-int" id="searchBlock1" style={{ display: showFilter ? 'block' : 'none' }}>
            <Form className="mt-1 filter-form" ref={formRef} onSubmit={handleSubmit(onSubmit)}>
                <div className="row mt-3 skel-filter-static">
                            ...
                            <Controller
                                ...
                                render={({ field: { onChange, onBlur, value, ref } }) => (
                                    <ReactSelect
                                        ...
                                        className="w-100"
                                        options={helpdeskChannels}
                                        isMulti={true}
                                        value={value ? helpdeskChannels.find(c => c.value === value) : null}
                                        onChange={val => onChange(val)}
                                    />
                                )}
                            />
                    ...
                    {/* <div className="col-md-12">
                        <div className="form-group">
                            <label htmlFor="idType" className="control-label"> By Helpdesk Category </label>
                            <Controller
                                control={control}
                                name="category"
                                render={({ field: { onChange, onBlur, value, ref } }) => (
                    ...
                    <div className="col-md-12">
                        <div className="form-group">
                            <label htmlFor="idType" className="control-label"> By Helpdesk Type </label>
                            <Controller
                                control={control}
                                name="helpdeskType"
                                render={({ field: { onChange, onBlur, value, ref } }) => (
                                    <ReactSelect
                                        ...
                                        className="w-100"
                                        options={helpdeskTypes}
                                        isMulti={true}
                                        value={value ? helpdeskTypes.find(c => c.value === value) : null}
                                        onChange={val => onChange(val)}
                                    />
                                )}
                            />
                    ...
                    {/* <div className="col-md-12">
                        <div className="form-group">
                            <label htmlFor="idType" className="control-label"> By Customer Location </label>
                            <Controller
                                control={control}
                                name="location"
                                render={({ field: { onChange, onBlur, value, ref } }) => (
