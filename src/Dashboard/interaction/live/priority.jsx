...
const LivePriority = memo((props) => {
    ...
    const getPriorityWiseInteraction = () => {
        ...
        axios.post(API_ENDPOINT + properties.INTERACTION_API + '/by-priority', { searchParams: { ...searchParams, category: "LIST", fromDate: moment().format('YYYY-MM-DD'), toDate: formattedFutureDate } }, {
            headers: {
            ...
            // console.log("live priority ==> ", resp);
            if (resp?.status == 200) {
    ...
    useEffect(() => {
        const interval = setInterval(() => {
            getPriorityWiseInteraction();
            // console.log('Running priority wise every 5 seconds');
    ...
    return (
        <div className="cmmn-skeleton">
            <div className="skel-dashboard-title-base">
                <span className="skel-header-title">Interaction by Priority</span>
