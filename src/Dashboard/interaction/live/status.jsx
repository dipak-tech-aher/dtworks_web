...
const LiveStatus = (props) => {
    ...
    const getStatusWiseInteraction = () => {
        ...
        axios.post(API_ENDPOINT + properties.INTERACTION_API + '/live-by-status/list', { searchParams: { ...searchParams, fromDate: moment().format('YYYY-MM-DD'), toDate: formattedFutureDate } }, {
            headers: {
    ...
    useEffect(() => {
        const interval = setInterval(() => {
            getStatusWiseInteraction(searchParams);
