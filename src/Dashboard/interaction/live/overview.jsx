...
const LiveOverview = (props) => {
    ...
    const getOverView = () => {
        ...
        axios.post(API_ENDPOINT + properties.INTERACTION_API + '/live-interactions-by-status', {searchParams: { ...searchParams, fromDate: moment().format('YYYY-MM-DD'), toDate: formattedFutureDate }}, {
            headers: {
            ...
            if (resp?.status == 200) {
                ...
                respData?.forEach(item => {
                    ...
                    const status = item?.intxnCategoryDesc?.description;
    ...
    return (
        <div className="cmmn-skeleton">
            <div className="skel-dashboard-title-base">
                <span className="skel-header-title">Interaction By Category</span>
