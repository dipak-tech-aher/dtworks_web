...
const barColors = ['#CFADFB', '#8654C6', "#CFF0BB", "#ff7f0e", "#2ca02c", '#54C1EE', '#4E33B0', '#654743', '#184636', 'RoyalBlue', 'green', 'yellow', 'orange', 'purple', 'red', 'grey', 'indigo', 'voilet', 'white', 'Pink', 'Cyan', '#E881F0', '#C876B5', '#E4DB07', '#914C83', '#7C37D3', '#867A5B', '#C29AE1', '#7C8B5B', '#EA4330', '#CFF0BB']
export default function AverageHandlingTimeChat() {
  ...
  const getChartData = (entity) => {
    try {
      ...
      setIsLoading(true)
      post(apiDetails[entity].endpoint + '/chat-average-handling-time', { searchParams: requestObj })
        .then((response) => {
    ...
    <div className="col-6 px-lg-1">
      <div className="cmmn-skeleton mh-480">
        <div className="skel-dashboard-title-base">
          ...
          Average Handling Time (AHT) - Chat
          </span>
        </div>
