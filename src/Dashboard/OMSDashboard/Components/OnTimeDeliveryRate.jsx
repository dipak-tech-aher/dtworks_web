...
const OnTimeDeliveryRate = () => {
    ...
    const [averageOnTimeDelivery, setAverageOnTimeDelivery] = useState(0);

    const getChartData = () => {
        try {
            let requestObj = { ...searchParams }
            setIsLoading(true)
            post(`${properties.ORDER_API}/oms-dashboard/top-customers`, { searchParams: requestObj })
                .then((response) => {
    ...
    useEffect(() => {
        ...
        const option = {
            ...
            legend: {
                data: ['On-Time Delivery Rate', 'Total Order Delivered'],
                bottom: 10
            },
            xAxis: [
                {
                        ...
                        <div className="skel-average-data">
                            ...
                            <span>
                                ...
                                <span className="skel-arrow-up">
                                    <strong>{averageOnTimeDelivery}% </strong>
                                    <i
