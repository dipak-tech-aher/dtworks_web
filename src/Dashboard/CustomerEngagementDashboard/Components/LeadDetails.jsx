...
import img1 from "../../../assets/images/t-pro.svg"
            ...
            .then((resp) => {
                if (resp?.data) {
                    if (resp?.status === 200) {
                        ...
                        const cData = axis.map(entityDate => {
        ...
        <div className="col-md-6 mb-0">
            <div className="cmmn-skeleton">
                <div className="skel-dashboard-title-base">
                    <span className="skel-header-title">Prospects Details</span>
                ...
                <div className="col-md-12">
                    <div className="skel-customer-avg-info skel-no-bord">
                        ...
                        <div className="skel-customer-active-info skel-prospects-full-info-bg">
                            <div className="skel-customer-active-info-lft">
                                <span>Total Prospects</span>
                                <span className="skel-fnt-md-bold">{data?.[0]?.oTotalCount ?? 0}</span>
                                </div>
                        ...
                        <div className="skel-avg-pre-cr">
                            <div className="skel-avg-sect-base">
                                <div className="skel-customer-avg-info-lft">
                                    <span>Avg. Prospects by Month</span>
                    ...
                    <div className="skel-graph-sect mt-3">
                        <ColumnChart
                            data={{
                                axisData,
                                seriesData,
                                title: 'Prospects Daily Statistics',
                                chartType: 'line',
                                chartProps: {
                                    smooth: true,
                                    color: '#FF5733'
