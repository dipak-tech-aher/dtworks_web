...
import img1 from "../../../assets/images/t-ord.svg"
        ...
        <div className="col-md-6 mb-2">
            <div className="cmmn-skeleton">
                <div className="skel-dashboard-title-base">
                    <span className="skel-header-title">Order Details</span>
                ...
                <div className="col-md-12">
                    <div className="skel-customer-avg-info skel-no-bord">
                            ...
                            <div className="skel-customer-active-info skel-order-full-info-bg">
