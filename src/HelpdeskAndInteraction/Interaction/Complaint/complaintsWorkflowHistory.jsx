...
const ComplaintsWorkflowHistory = (props) => {
            ...
            <div className="modal-dialog" style={{ maxWidth: "1142px", margin: "0", maxHeight: "500px" }}>
                <div className="modal-content">
                    <div className="modal-header">
                        <h4 className="modal-title" id="myCenterModalLabel">Complaint Workflow History</h4>
                    ...
                    </div>
                    {
                        data.length > 0 ?
                            ...
                            :
                            message === true ?
                                <p className='row pt-4 d-flex justify-content-center bold' style={{ fontSize: "20px" }}>Complaint ID {workFlowData.intxnId} is in {workFlowData.currStatus} status</p>
                                :
                                ""
                    }
                </div>
...
export default ComplaintsWorkflowHistory;