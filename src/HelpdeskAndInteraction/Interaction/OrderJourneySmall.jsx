...
const OrderJourneySmall = ((props) => {
	...
	useEffect(() => {
		const { data, height="450%", width="250%" } = props;
					...
					series: [
						{
							...
							label: {
								...
								formatter: function ({ data }) {
									...
									const flwDate = flowDate ? moment(flowDate).format('DD-MM-YY') : '-'
...
export default OrderJourneySmall;
