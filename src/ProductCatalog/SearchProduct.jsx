...
const SearchProduct = (props) => {
    ...
    const productTableColumns = [
        ...
        {
            Header: `${appConfig?.clientFacingName?.product ?? "Product"} Name`,
            accessor: "productName",
            disableFilters: false,
            id: "productName"
        },        
        {
            Header: `${appConfig?.clientFacingName?.product ?? "Product"} Type`,
            accessor: "productTypeDescription.description",
            disableFilters: true
        },
        {
            Header: `${appConfig?.clientFacingName?.product ?? "Product"} Sub Type`,
                    ...
                    <section className="triangle">
                        <div className="row align-items-center p-2">
                            <div className="col max-auto">
                                <h5 id="list-item-1" className="">Add / Edit {appConfig?.clientFacingName?.product ?? "Product"}</h5>
                            </div>
                            <div className="col-auto mx-auto">
                                {/* <div className="input-group input-group-sm pr-1 form-inline"> */}
                                    ...
                                    <button type="button" className="skel-btn-submit"
                                        onClick={() => { handleAddEditButton('create', null) }}>Add {appConfig?.clientFacingName?.product ?? "Product"}</button>
                                {/* </div> */}
                            </div>
                        </div>
                    </section>
                ...
                <div className='m-1 skel-table-list-single'>
                    {
                        ...
                        <DynamicTable
                            ...
                            listKey={`${appConfig?.clientFacingName?.product ?? "Product"} List`}
                            row={productList}
                            rowCount={totalCount}
