...
import createdOrderColumns from './Columns/CreatedOrderColumns'

const CreatedOrderReport = () => {
    const initialValues = {
        orderNo: '',
        orderStatus: '',
        currEntity: '',
        ...
        'From Date': moment().subtract('1', 'month').format('YYYY-MM-DD'),
    ...
    const handleInputChange = (e) => {
        ...
        unstable_batchedUpdates(() => {
            ...
            if (dataAttributeName) {
                setSearchCriteria({ ...SearchCriteria, [dataAttributeName]: target.value });
            }
        })
    ...
    const getOrderDetails = useCallback(() => {
        ...
        post(`${properties.REPORTS_API}/created-orders?limit=${perPage}&page=${currentPage}`, requestBody)
            .then((resp) => {
                if (resp.data) {
                    if (resp.status === 200) {
                    ...
                    <div className="col-12">
                        <section className="triangle">
                            <div className="col-12 row">
                                <div className="col-12"><h4 className="pl-3">Created Order Report</h4></div>
                            </div>
                        </section>
                    </div>
                </div>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-md-3">
                                                <div className="form-group">
                                                    ...
                                                    <select className="form-control" id="orderCategory" value={searchInputs.orderCategory} onChange={handleInputChange} data-name='Order Category'>
                                            ...
                                            <div className="col-md-3">
                                                <div className="form-group">
                                                    ...
                                                    <select className="form-control" id="orderType" value={searchInputs.orderType} onChange={handleInputChange} data-name='Order Type'>
                                            ...
                                            <div className="col-md-3">
                                                <div className="form-group">
                                                    ...
                                                    <select className="form-control" id="serviceType" value={searchInputs.serviceType} onChange={handleInputChange} data-name='Service Type'>
                                            ...
                                            <div className="col-md-3">
                                                <div className="form-group">
                                                    ...
                                                    <select className="form-control" id="orderPriority" value={searchInputs.orderPriority} onChange={handleInputChange} data-name='Order Priority'>
                                            ...
                                            <div className="col-md-3">
                                                <div className="form-group">
                                                    ...
                                                    <select className="form-control" id="orderSource" value={searchInputs.orderSource} onChange={handleInputChange} data-name='Order Source'>
                                                        <option value="">Select Order Priority</option>
                                                        {
                                    ...
                                    <div className="card-body" id="datatable">
                                        <div style={{}}>
                                            <DynamicTable
                                                ...
                                                listKey={"Created Order Report"}
                                                row={searchData}
                                                rowCount={totalCount}
                                                header={createdOrderColumns}
                                                ...
                                                exportBtn={exportBtn}
                                                url={properties.REPORTS_API + '/created-orders'}
                                                method={'POST'}
                                                report={true}
                                                handler={{
...
export default CreatedOrderReport