...
import closedOrderColumns from './Columns/ClosedOrderColumns'

const ClosedOrderReport = () => {
    const initialValues = {
        orderNo: '',
        orderStatus: '',
        currEntity: '',
    ...
    const getOrderDetails = () => {
        ...
        post(`${properties.REPORTS_API}/closed-orders?limit=${perPage}&page=${currentPage}`, requestBody)
            .then((resp) => {
                if (resp.data) {
                    if (resp.status === 200) {
                    ...
                    <div className="col-12">
                        <section className="triangle">
                            <div className="col-12 row">
                                <div className="col-12"><h4 className="pl-3">Closed Order Report</h4></div>
                            </div>
                        </section>
                    </div>
                </div>
                                    ...
                                    <div className="card-body" id="datatable">
                                        <div style={{}}>
                                            <DynamicTable
                                                ...
                                                listKey={"Closed Order Report"}
                                                row={searchData}
                                                rowCount={totalCount}
                                                header={closedOrderColumns}
                                                ...
                                                exportBtn={exportBtn}
                                                url={properties.REPORTS_API + '/closed-orders'}
                                                method={'POST'}
                                                handler={{
...
export default ClosedOrderReport