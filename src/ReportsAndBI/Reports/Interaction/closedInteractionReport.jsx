...
const ClosedInteractionReport = (props) => {
    ...
    useEffect(() => {
        setCustomerSearchColumns(openInteractionColumnsProp?.map(x => {
    ...
    useEffect(() => {
        try {
            get(properties.BUSINESS_ENTITY_API + '?searchParam=code_type&valueParam=INTXN_TYPE,CUSTOMER_CATEGORY,PROBLEM_CODE')
                .then((response) => {
                    if (response.data) {
    ...
    const getInteraction = useCallback((uid) => {
        if (uid) {
            setListSearch({ uid })
            showSpinner()
            axios.get(`${API_ENDPOINT}${properties.REPORTS_API}/get-report/closed-interaction?limit=${perPage}&page=${currentPage}&uuid=${uid}`,
                {
                    headers: {
                        "x-tenant-id":
    ...
    const getReportDetails = useCallback(() => {
        ...
        showSpinner()
        axios.post(`${API_ENDPOINT}${properties.REPORTS_API}/interaction/closed`,
            { ...requestBody },
            { headers: {  "x-tenant-id":
            process.env.NODE_ENV === "development"
              ? properties.REACT_APP_TENANT_ID
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const permissions = await getPermissions('CLOSED_INTXN_RPT');
        ...
        const getMetaConfig = async () => {
            try {
                ...
                setConsumerFromIsEnabled(response?.configValue);
            } catch (error) {
                console.error('Error fetching specific system config:', error);
            }
        };
                    ...
                    <div className="col-12">
                        <section className="triangle">
                            <div className="row p-0">
                                <div className="col"><h4 className="">Closed Interaction Report</h4></div>
                            </div>
                        </section>
                    </div>
                </div>
                ...
                <div className="col-lg-12">
                            ...
                            displayForm && (
                                <form onSubmit={handleSubmit}>
                                    ...
                                    />
                                        ...
                                        {/* {appConfig?.clientConfig?.report?.createdInteraction?.fields.includes('status') && <div className="col-lg-3 col-md-4 col-sm-12">
                                            <div className="form-group">
                                        ...
                                        {appConfig?.clientConfig?.report?.createdInteraction?.fields.includes('profileNo') && <div className="col-lg-3 col-md-4 col-sm-12">
                                            <div className="form-group">
                                                <label htmlFor="reference_number" className="control-label">{appConfig?.clientFacingName['Customer'.toLowerCase()]} No</label>
                                                <input value={searchInputs?.reference_number}
                                                    onChange={handleInputChange} type="text" className="form-control" id="reference_number"  data-name={appConfig?.clientFacingName["Customer".toLowerCase()] + "No"}
                                                />
                                            </div>
                                        </div>}
                                        {appConfig?.clientConfig?.report?.createdInteraction?.fields.includes('profileName') && <div className="col-lg-3 col-md-4 col-sm-12">
                                            <div className="form-group">
                                                <label htmlFor="reference_name" className="control-label">{appConfig?.clientFacingName['Customer'.toLowerCase()]} Name </label>
                                                <input value={searchInputs?.reference_name}
                                                    onChange={handleInputChange} type="text" className="form-control" id="reference_name"  data-name={appConfig?.clientFacingName["Customer".toLowerCase()] + "Name"}
                                                />
                                            </div>
                                        </div>}
                    ...
                    {appConfig?.clientConfig?.report?.createdInteraction?.fields.includes(
                        "IntxtStatment"
                         ...
                         {appConfig?.clientConfig?.report?.createdInteraction?.fields.includes('dateFrom') && 
                         <div className="col-lg-3 col-md-4 col-sm-12">
                                            <div className="form-group">
                                                <label htmlFor="Date From" className="control-label">From Date</label>
                                                <input type="date" min={moment(dateVariable).format('YYYY-MM-DD')} value={searchInputs.dateFrom} onChange={handleInputChange} className="form-control" id="dateFrom"  data-name='From Date'/>
                                        ...
                                        {appConfig?.clientConfig?.report?.createdInteraction?.fields.includes('dateTo') && <div className="col-lg-3 col-md-4 col-sm-12">
                                            <div className="form-group">
                                                ...
                                                <input type="date" min={moment(dateVariable).format('YYYY-MM-DD')} value={searchInputs.dateTo} onChange={handleInputChange} className="form-control" id="dateTo" data-name='To Date'/>
                                        ...
                                        <div className="row">
                                            ...
                                            {appConfig?.clientConfig?.report?.createdInteraction?.fields.includes('profileNo') && <div className="col-lg-3 col-md-4 col-sm-12">
                                                <div className="form-group">
                                                    <label htmlFor="reference_number" className="control-label">{appConfig?.clientFacingName['Customer'.toLowerCase()]} No</label>
                                                    <input value={searchInputs?.reference_number}
                                                        onChange={handleInputChange} type="text" className="form-control" id="reference_number"
                                                    />
                                                </div>
                                            </div>}
                                            {appConfig?.clientConfig?.report?.createdInteraction?.fields.includes('profileName') && <div className="col-lg-3 col-md-4 col-sm-12">
                                                <div className="form-group">
                                                    <label htmlFor="reference_name" className="control-label">{appConfig?.clientFacingName['Customer'.toLowerCase()]} Name </label>
                                                    <input value={searchInputs?.reference_name}
                                                        onChange={handleInputChange} type="text" className="form-control" id="reference_name"
                                                    />
                                                </div>
                                            </div>}
                                            {appConfig?.clientConfig?.report?.createdInteraction?.fields.includes('problemCode') && <div className="col-lg-3 col-md-4 col-sm-12">
                                                <div className="form-group">
                                                    <label htmlFor="problemCode" className="control-label">Problem Type</label>
                                                    <select className="form-control" id="problemCode" value={searchInputs.problemCode} onChange={handleInputChange}>
                                                        <option value="">Select Problem Code</option>
                                                        {
                                            ...
                                            {appConfig?.clientConfig?.report?.createdInteraction?.fields.includes('IntxtStatment') && <div className="col-lg-3 col-md-4 col-sm-12">
                                                <div className="form-group">
                                                    <label htmlFor="intxn_statement" className="control-label">Interaction Statement</label>
                                                    <select className="form-control" id="intxn_statement" value={searchInputs?.intxn_statement} onChange={handleInputChange}>
                                                        <option value="">Select interaction statement</option>
                                                        {
                                                            intxtStatmentLookup && intxtStatmentLookup.map((e) => (
                                    ...
                                    <div className="" id="datatable">
                                        <div style={{}}>
                                            <DynamicTable
                                                ...
                                                exportBtn={exportBtn}
                                                report={true}
                                                reportName={"Closed Interaction Report"}
                                                url={`${properties.REPORTS_API}/get-report/closed-interaction?limit=${perPage}&page=${currentPage}&uuid=${uid}`}
                                                method={'GET'}
                                                handler={{
...
// import { formFilterObject } from '../../../common/util/util'
// import { closedInteractionColumns as closedInteractionColumnsProp } from './Columns/closedInteractionColumns'
...
//     useEffect(() => {
//         setCustomerSearchColumns(closedInteractionColumnsProp?.map(x => {
//             //if (["customerNo", "customerName", "customerServiceStatus"].includes(x.id)) {
//             if (appConfig && appConfig.clientFacingName && appConfig.clientFacingName['Customer'.toLowerCase()]) {
//                 x.Header = x.Header?.replace('Customer', appConfig?.clientFacingName['Customer'.toLowerCase()] || 'Customer');
//             }
...
//     // INTERACTION_STATUS,CUSTOMER_CATEGORY
//     useEffect(() => {
//         get(properties.BUSINESS_ENTITY_API + '?searchParam=code_type&valueParam=INTXN_TYPE,PROJECT')
//             .then((response) => {
//                 if (response.data) {
//                     let lookupData = response.data;
//                     let ProjectFilterData = lookupData['PROJECT'] && lookupData['PROJECT'].length > 0 && lookupData['PROJECT'].filter((val) => val?.mapping && val?.mapping?.department?.length > 0 && val?.mapping?.department.includes(auth.currDeptId));
...
//         console.log(properties.REPORTS_API)
...
//                                                 hasExternalSearch={hasExternalSearch}
//                                                 exportBtn={exportBtn}
//                                                 // url={properties.REPORTS_API + '/closed-interaction'}
//                                                 report={true}
//                                                 // method={'POST'}
//                                                 handler={{
//                                                     handleCellRender: handleCellRender,
...
//         //                                     <div className="col-md-3">
//         //                                         <div className="form-group">
//         //                                             <label htmlFor="customerNo" className="control-label">{appConfig?.clientFacingName?.customer ?? 'Customer'} No</label>
...
//         //                                     <div className="col-md-3">
//         //                                         <div className="form-group">
//         //                                             <label htmlFor="Customer Name" className="control-label">{appConfig?.clientFacingName?.customer ?? 'Customer'} Name</label>
...
//         //                                         <div className="form-group">
//         //                                             <label htmlFor="Date From" className="control-label">From Date</label>
//         //                                             <input type="date" value={searchInputs.dateFrom} onChange={handleInputChange}  max={moment(new Date()).format('YYYY-MM-DD')} className="form-control" id="dateFrom"
//         //                                             />
//         //                                         </div>
//         //                                     </div>
//         //                                     <div className="col-md-3">
//         //                                         <div className="form-group">
//         //                                             <label htmlFor="To From" className="control-label">To Date</label>
//         //                                             <input type="date" value={searchInputs.dateTo} onChange={handleInputChange}
//         //                                              min={moment(new Date(searchInputs.dateFrom) || new Date()).format('YYYY-MM-DD')}
//         //                                                 max={moment(new Date()).format('YYYY-MM-DD')}
//         //                                                 className="form-control" id="dateTo"
//         //                                             />
//         //                                         </div>
//         //                                     </div>
//         //                                 </div>
