...
const CreatedTaskReport = () => {
    ...
    const handleSubmit = (e) => {
        ...
        post(`${properties.REPORTS_API}/tasks/created`, requestBody)
            .then((resp) => {
                if (resp.data) {
    ...
    const getTaskDetails = () => {
        get(`${properties.REPORTS_API}/get-task/created?limit=${perPage}&page=${currentPage}&uuid=${uuid}`)
            .then((resp) => {
                if (resp.data) {
                    if (resp.status === 200) {
                                    ...
                                    <div className="card-body" id="datatable">
                                        <div style={{}}>
                                            <DynamicTable
                                                ...
                                                exportBtn={exportBtn}
                                                url={`${properties.REPORTS_API}/get-task/created?limit=${perPage}&page=${currentPage}&uuid=${uuid}`}
                                                method={'GET'}
                                                handler={{
...
export default CreatedTaskReport