...
const SalesReport = (props) => {
    ...
    const getLoginDetails = () => {
        ...
        post(`${properties.REPORTS_API}/salesSearch?limit=${perPage}&page=${currentPage}`, searchInputs)
            .then((resp) => {
                if (resp.data) {
                    if (resp.status === 200) {
    ...
    const handleCellRender = (cell, row) => {
        if (cell.column.Header === "Work Order Initiation Date" || cell.column.Header === "Work Order Closed Date"
            || cell.column.Header === "Service Start Date" || cell.column.Header === "Service End Date") {
            return (
                    ...
                    <div className="col-12">
                        <section className="triangle">
                            <div className="col-12 row">
                                <div className="col-12"><h4 className="pl-3">Sales Report</h4></div>
                            </div>
                        </section>
                    </div>
                </div>
                                            ...
                                            <div className="autoheight p-1">
                                                <section>
                                                    <div className="form-row pb-2 col-12">
                                                        ...
                                                        <div className="col-lg-3 col-md-4 col-sm-12">
                                                            <div className="form-group">
                                                                <label htmlFor="woRefNumber" className="control-label">Work Order Referance Number</label>
                                                                <input
                                                                    value={searchInputs.woRefNumber}
                                                                    onKeyPress={(e) => {
                                                                        if (e.key === "Enter") {
                                                                            handleSubmit(e)
                                                                        };
                                                        ...
                                                        <div className="col-lg-3 col-md-4 col-sm-12">
                                                            <div className="form-group">
                                                                <label htmlFor="serviceNumber" className="control-label">Service Type</label>
                                                                <select className="form-control" id="productType" value={searchInputs.productServiceType} onChange={handleInputChange}>
                                                                    <option value="">Select Service Type</option>
                                                                    {
                                                                        productServiceTypeLookup && productServiceTypeLookup.map((e) => (
                                                        ...
                                                        <div className="col-lg-3 col-md-4 col-sm-12">
                                                            <div className="form-group">
                                                                <label htmlFor="productName" className="control-label">Product Name</label>
                                                                <input
                                                        ...
                                                        <div className="col-lg-3 col-md-4 col-sm-12">
                                                            <div className="form-group">
                                                                <label htmlFor="serviceStartDate" className="control-label">Service Start Date</label>
                                                                <input type="date" id="serviceStartDate" className="form-control"
                                                                    value={searchInputs.serviceStartDate}
                                                                    onKeyPress={(e) => {
                                                                        if (e.key === "Enter") {
                                                                            handleSubmit(e)
                                                                        };
                                                        ...
                                                        <div className="col-lg-3 col-md-4 col-sm-12">
                                                            <div className="form-group">
                                                                <label htmlFor="serviceEndDate" className="control-label">Service End Date</label>
                                                                <input type="date" id="serviceEndDate" className="form-control"
                                                                    value={searchInputs.serviceEndDate}
                                                                    onKeyPress={(e) => {
                                                                        if (e.key === "Enter") {
                                                                            handleSubmit(e)
                                                                        };
                                                        ...
                                                        <div className="col-lg-3 col-md-4 col-sm-12">
                                                            <div className="form-group">
                                                                <label htmlFor="accountManager" className="control-label">Account Manager</label>
                                                                <input
                                                                    value={searchInputs.accountManager}
                                                                    onKeyPress={(e) => {
                                                                        if (e.key === "Enter") {
                                                                            handleSubmit(e)
                                                                        };
                                    ...
                                    <div className="card-body" id="datatable">
                                        <div style={{}}>
                                            <DynamicTable
                                                ...
                                                exportBtn={exportBtn}
                                                url={properties.REPORTS_API + '/salesSearch'}
                                                method={'POST'}
                                                handler={{
