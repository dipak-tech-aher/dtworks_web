...
const SLAMenu = ({ totalCount, steps, setNextStepCount }) => {
                ...
                <div className="row">
                    {
                        steps && steps.map((step, index) => (
                            <div className="col-lg-4 col-md-4 col-xs-12 skel-res-m" key={index}>
                                <div className="skel-config-steps" onClick={() => { history(`${step.path}`, { state: { data: { sourceName: step.sourceName } } }); setNextStepCount(index) }}>
