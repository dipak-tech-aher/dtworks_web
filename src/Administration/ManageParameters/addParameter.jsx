...
const AddParameter = (props) => {
    ...
    const options = props.Code.adminMenu
    const setDisplay = props.setDisplay
    const codeType = props.Code.codeType
    // const activeType = props?.code?.isActive
    ...
    //     if (error) return;
    //     post(properties.MASTER_API, data)
    //         .then((resp) => {
    //             if (resp.status === 200) {
    //                 setDisplay(false)
    ...
    const handleBusinessParameterChange = (e) => {
        ...
        if (target.value !== "") {
            ...
            const Tooltip = parameterList.find(f => f.codeType === target.value)?.helpTips
            setTooltip(Tooltip)
        } else {
    ...
    const handleEditParameterMapping = () => {
        ...
        post(properties.MASTER_API + "/", requestBody)
            .then((resp) => {
                if (resp.status === 200) {
            ...
            <div className="modal-dialog " role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title" id="followupModal">Add Parameters</h5>
                        <button type="button" className="close" data-dismiss="modal" aria-label="Close" onClick={() => setDisplay(false)}>
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div className="modal-body">
                        <div className={`skel-form-heading-bar mt-2`}>
                            <span className="messages-page__title">Add</span>
                        </div>
                            ...
                            <div className="col-12 align-items-left">
                                ...
                                <div className='d-flex d-flex-algn-center'>
                                    ...
                                    <div>
                                        ...
                                        <Tooltip anchorId="businessParameter" place="right" effect="float" textColor="white">
                        ...
                        <div className="modal-body bg-secondary m-2">
                            <div className="col-12">
                                <div className="row">
                                    ...
                                    <div className="col-lg-1 col-md-1 col-sm-12 text-center" style={{ maxWidth: "45px" }}>
                    ...
                    <div className="col-md-12 pl-2">
                        <div className="form-group pb-1">
                            <div className="skel-btn-center-cmmn">
                                <button type="button" className="skel-btn-cancel" onClick={() => { setDisplay(false) }}>Cancel</button>
                                <button type="button" className="skel-btn-submit" onClick={handleEditParameterMapping}>Submit</button>
                            </div>
                        </div>
                    </div>
                </div>
